...
namespace System {
	...
	public partial struct Rune {
		...
		public static bool IsDigit (Rune rune) => Intellivoid.NStack.Unicode.IsDigit (rune.value);
		...
		/// </remarks>
		public static bool IsGraphic (Rune rune) => Intellivoid.NStack.Unicode.IsGraphic (rune.value);
		...
		/// </remarks>
		public static bool IsPrint (Rune rune) => Intellivoid.NStack.Unicode.IsPrint (rune.value);
		...
		/// </remarks>
		public static bool IsControl (Rune rune) => Intellivoid.NStack.Unicode.IsControl (rune.value);
		...
		/// <remarks>
		/// </remarks>
		public static bool IsLetter (Rune rune) => Intellivoid.NStack.Unicode.IsLetter (rune.value);
		...
		/// <remarks>
		/// </remarks>
		public static bool IsLetterOrDigit (Rune rune) => Intellivoid.NStack.Unicode.IsLetter (rune.value) || Intellivoid.NStack.Unicode.IsDigit (rune.value);
		...
		/// <remarks>
		/// </remarks>
		public static bool IsLetterOrNumber (Rune rune) => Intellivoid.NStack.Unicode.IsLetter (rune.value) || Intellivoid.NStack.Unicode.IsNumber (rune.value);
		...
		/// </remarks>
		public static bool IsMark (Rune rune) => Intellivoid.NStack.Unicode.IsMark (rune.value);
		...
		/// </remarks>
		public static bool IsNumber (Rune rune) => Intellivoid.NStack.Unicode.IsNumber (rune.value);
		...
		/// </remarks>
		public static bool IsPunctuation (Rune rune) => Intellivoid.NStack.Unicode.IsPunct (rune.value);
		...
		/// </remarks>
		public static bool IsWhiteSpace (Rune rune) => Intellivoid.NStack.Unicode.IsSpace (rune.value);
		...
		/// <returns><c>true</c>, if the rune is a mark, <c>false</c> otherwise.</returns>
		/// <param name="rune">The rune to test for.</param>
		public static bool IsSymbol (Rune rune) => Intellivoid.NStack.Unicode.IsSymbol (rune.value);
		...
		/// <param name="rune">The rune to test for.</param>
		public static bool IsUpper (Rune rune) => Intellivoid.NStack.Unicode.IsUpper (rune.value);
		...
		/// <returns><c>true</c>, if the rune is a lower case lette, <c>false</c> otherwise.</returns>
		/// <param name="rune">The rune to test for.</param>
		public static bool IsLower (Rune rune) => Intellivoid.NStack.Unicode.IsLower (rune.value);
		...
		/// <returns><c>true</c>, if the rune is a lower case lette, <c>false</c> otherwise.</returns>
		/// <param name="rune">The rune to test for.</param>
		public static bool IsTitle (Rune rune) => Intellivoid.NStack.Unicode.IsTitle (rune.value);
		...
		public static Rune To (Case toCase, Rune rune)
		{
			...
			switch (toCase) {
			case Case.Lower: 
				return new Rune (Intellivoid.NStack.Unicode.To (Intellivoid.NStack.Unicode.Case.Lower, rval));
			case Case.Title:
				return new Rune (Intellivoid.NStack.Unicode.To (Intellivoid.NStack.Unicode.Case.Title, rval));
			case Case.Upper:
				return new Rune (Intellivoid.NStack.Unicode.To (Intellivoid.NStack.Unicode.Case.Upper, rval));
			}
		...
		public static Rune ToUpper (Rune rune) => Intellivoid.NStack.Unicode.ToUpper (rune.value);
		...
		/// <param name="rune">Rune.</param>
		public static Rune ToLower (Rune rune) => Intellivoid.NStack.Unicode.ToLower (rune.value);
		...
		/// <returns>The lower cased rune if it can be.</returns>
		/// <param name="rune">Rune.</param>
		public static Rune ToTitle (Rune rune) => Intellivoid.NStack.Unicode.ToTitle (rune.value);
		...
		/// </code>
		/// </remarks>
		public static Rune SimpleFold (Rune rune) => Intellivoid.NStack.Unicode.SimpleFold (rune.value);
