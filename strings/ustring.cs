...
namespace Intellivoid.NStack {
...
#endif
	{
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="T:Intellivoid.NStack.ustring"/> class using the provided byte array for its storage.
		/// </summary>
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="T:Intellivoid.NStack.ustring"/> class from a string.
		/// </summary>
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="T:Intellivoid.NStack.ustring"/> class from an array of C# characters.
		/// </summary>
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="T:Intellivoid.NStack.ustring"/> class from an array of Runes.
		/// </summary>
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="T:Intellivoid.NStack.ustring"/> class from an IEnumerable of runes
		/// </summary>
		/// <returns>The make.</returns>
		/// <param name="runes">Runes.</param>
		...
		/// Initializes a new instance of the <see cref="T:Intellivoid.NStack.ustring"/> class from an array of uints, which contain CodePoints.
		/// </summary>
		/// <returns>The make.</returns>
		/// <param name="runes">Runes.</param>
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="T:Intellivoid.NStack.ustring"/> class from a block of memory and a size.
		/// </summary>
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="T:Intellivoid.NStack.ustring"/> class from a null terminated block of memory.
		/// </summary>
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="T:Intellivoid.NStack.ustring"/> by making a copy of the specified block.
		/// </summary>
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="T:Intellivoid.NStack.ustring"/> by making a copy of the null-terminated block of memory.
		/// </summary>
		/// <param name="block">Pointer to a block of memory, it is expected to be terminated by a 0 byte.</param>
		/// <remarks>
		/// <para>
		...
		/// <summary>
		/// Serves as a hash function for a <see cref="T:Intellivoid.NStack.ustring"/> object.
		/// </summary>
		...
		/// <summary>
		/// Determines whether the specified <see cref="object"/> is equal to the current <see cref="T:Intellivoid.NStack.ustring"/>.
		/// </summary>
		/// <param name="obj">The <see cref="object"/> to compare with the current <see cref="T:Intellivoid.NStack.ustring"/>.</param>
		/// <returns><c>true</c> if the specified <see cref="object"/> is equal to the current <see cref="T:Intellivoid.NStack.ustring"/>;
		...
		/// Determines whether the specified <see cref="object"/> is equal to the current <see cref="T:Intellivoid.NStack.ustring"/>.
		/// </summary>
		/// <param name="other">The other string to compare with the current <see cref="T:Intellivoid.NStack.ustring"/>.</param>
...
#endif
		/// <summary>
		/// Initializes a new instance of the <see cref="T:Intellivoid.NStack.ustring"/> class from a byte array.
		/// </summary>
		/// <param name="buffer">Buffer containing the utf8 encoded string.</param>
		...
		/// <summary>
		/// Gets a value indicating whether this <see cref="T:Intellivoid.NStack.ustring"/> is empty.
		/// </summary>
		...
		/// <returns>The <see cref="T:Intellivoid.NStack.ustring"/> that is the concatenation of the strings of <c>u1</c> and <c>u2</c>.</returns>
